const addressController = require("./chain");

const NETWORKS = addressController.NETWORKS;
...
const getNetworkAddress = (chainId) => {
	if (chainId == -1) {
...
module.exports = { ADDRESS, getNetworkAddress, IPFS_URL };
